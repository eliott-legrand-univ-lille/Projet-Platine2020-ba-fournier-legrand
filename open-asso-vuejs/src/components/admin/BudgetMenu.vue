...
<template>
<div>
    <TopBar title="Budget" color="#673ab7" back></TopBar>
    <v-content>
        <v-container fluid>
             <v-row >
                <v-col class="d-flex flex-column align-center" v-for="n in Menu.length"  :key="n">
                  <v-card width="100px" height="100px" class="d-flex flex-column justify-center align-center"
                  color="#673ab7"
                  >
